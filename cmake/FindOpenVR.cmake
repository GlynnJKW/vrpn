...
if(${_platform_base} MATCHES "win")
    set(_libfile ${OPENVR_ROOT_DIR}/${_libpath}/openvr_api.lib)
elseif(${_platform_base} MATCHES "linux")
    set(_libfile ${OPENVR_ROOT_DIR}/${_libpath}/libopenvr_api.so)
endif()
...
set(OPENVR_LIBRARY
    ...
    CACHE
    PATH
    "Library file to be linked in openvr compilation")
